...
import com.em.comm.HTTPMethod;
import com.em.comm.Roles;
import com.em.utils.HTTPClientUtils;
import com.em.vo.ClientSecretCredential;
import com.em.vo.Credential;
import com.em.vo.EndPoints;
...
public class EasemobIMUsers {
	...
	public static void main(String[] args) {
		// regSingleAccount("weikai");
		//
		// String usernamePrefix = "weikai";
		// Long perNumber = 10l;
		// Long totalNumber = 100l;
		// regBatchAccount(usernamePrefix, perNumber, totalNumber);

		// /**
		// * IM用户登录
		// */
		// ObjectNode imUserLoginNode =
		// imUserLogin(datanode.get("username").asText(),
...
//		}
		...
		// regSingleAccount("weikai2775");
//		 regBatchAccount("weikaics", 1l, 20l);
	}

	/**
	 * 注册IM用户[批量生成用户然后注册]
	 */
	public static void regBatchAccount(String usernamePrefix, Long perNumber, Long totalNumber) {
	 ...
	 * 注册IM用户[单个]
	 */
	public static void regSingleAccount(String userName) {
	 ...
	 * @return
	 */
	private static ObjectNode createNewIMUserBatch(ArrayNode dataArrayNode) {
	...
	public static ObjectNode deleteIMUserByUsernameBatch(Long limit) {
		...
		try {
			...
			URL deleteIMUserByUsernameBatchUrl = HTTPClientUtils
					.getURL(Constants.APPKEY.replace("#", "/") + "/users" + "?limit=" + limit);
	...
	public static ObjectNode deleteFriendSingle(String ownerUserName, String friendUserName) {
		...
		try {
			...
			ObjectNode body = factory.objectNode();
			objectNode = HTTPClientUtils.sendHTTPRequest(addFriendSingleUrl, credential, body,
					HTTPMethod.METHOD_DELETE);
	...
	public static ObjectNode getFriends(String ownerUserName) {
		...
		try {
			...
			URL addFriendSingleUrl = HTTPClientUtils
					.getURL(Constants.APPKEY.replace("#", "/") + "/users/" + ownerUserName + "/contacts/users");
