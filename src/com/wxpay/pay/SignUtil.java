...
import cc.messcat.service.member.MemberManagerDaoImpl;
...
public class SignUtil {
    ...
    /**
     * 返回的沙箱密钥
     * @param generateSignedXml
     * @return
     */
    public static String getSanboxSign(String generateSignedXml) {
        String response = GetJsonData.getXmlData(generateSignedXml,"https://api.mch.weixin.qq.com/sandboxnew/pay/getsignkey");
        try {
