...
public class Demo {
	...
	public static void main(String[] args) {
		//long accessId = Long.valueOf(PropertiesFileReader.getByKey("xingeApp.ios.accessId"));
		//String secretKey = PropertiesFileReader.getByKey("xingeApp.ios.secretKey");
		long accessId = Long.valueOf(PropertiesFileReader.getByKey("xingeApp.coach.android.accessId"));
		String secretKey = PropertiesFileReader.getByKey("xingeApp.coach.android.secretKey");
		//long accessId = Long.valueOf(PropertiesFileReader.getByKey("xingeApp.android.accessId"));
		//String secretKey = PropertiesFileReader.getByKey("xingeApp.android.secretKey");
		//String token ="22a30b340483b52b42be938637b37e1a3455458a";
		//String token ="3820df6351bfafd147089a534785a31053ade31f";
		String content = "亲爱的开发者您好";
		// 易用接口
		//System.out.println(XingeApp.pushTokenAndroid(accessId, secretKey, "哈哈", content, token));
		
		//System.out.println(XingeApp.pushTokenAndroid(accessId, secretKey, "华科大", content, token, "2"));
		
		//System.out.println(XingeApp.pushAccountAndroid(000, "secretKey", "test", "测试", "account"));
		//System.out.println(XingeApp.pushAllAndroid(accessId, secretKey, "test", "测试"));
		...
		//System.out.println(XingeApp.pushTagIos(accessId, secretKey, content, "1_student_ios", XingeApp.IOSENV_PROD));
