...
import cc.messcat.vo.TrainMsgData;
...
public class XingeApp {
	...
	public static final Long ANDROID_ACCESSID = 2100263692l;
	public static final String ANDROID_SECRET_KEY = "87bbb441fe8963169c3ccc9000b5f9e5";

	public static final Long IOS_ACCESSID = 2200263583l;
	public static final String IOS_SECRET_KEY = "83a642795086abb26ed59876f492b41e";
	...
	public static JSONObject pushTokenAndroid(long accessId, String secretKey, String title, String content,
		...
		Map<String, Object> m_custom = new HashMap<String, Object>();
		m_custom.put("msgType", 0);
		m_custom.put("data", "");
		message.setCustom(m_custom);
	 ...
	 * @return
	 */
	public static JSONObject pushTokenAndroidTrain(long accessId, String secretKey, String title, String content,
			String token, int msgType, String data) {
		Message message = new Message();
		Style style = new Style(0);
		message.setType(Message.TYPE_NOTIFICATION);
		message.setTitle(title);
		...
		message.setStyle(style);
		Map<String, Object> m_custom = new HashMap<String, Object>();
		// WedriveCustom wedriveCustom = new WedriveCustom();
		// wedriveCustom.setMsgType(Constants.WEDRIVE_CUSTOM_MSGTYPE_TRAIN);
		m_custom.put("msgType", msgType);
		m_custom.put("data", data);
		message.setCustom(m_custom);
	 ...
	 * @return
	 */
	public static JSONObject pushTokenIosTrain(long accessId, String secretKey, String content, String token, int env,
